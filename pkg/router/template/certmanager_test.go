...
func TestCertManager(t *testing.T) {
	...
	}{"add cert nil config": {expectedAdds: []string{}, expectedDeletes: []string{}}, "add cert edge": {cfg: &ServiceAliasConfig{Host: "www.example.com", TLSTermination: routev1.TLSTerminationEdge, Certificates: map[string]Certificate{"www.example.com": {ID: "testCert"}, "www.example.com" + caCertPostfix: {ID: "testCert"}}}, expectedAdds: []string{cfg.certDir + "testCert"}, expectedDeletes: []string{cfg.certDir + "testCert"}}, "add cert passthrough": {cfg: &ServiceAliasConfig{Host: "www.example.com", TLSTermination: routev1.TLSTerminationPassthrough, Certificates: map[string]Certificate{"www.example.com": {ID: "testCert"}, "www.example.com" + caCertPostfix: {ID: "testCert"}}}, expectedAdds: []string{}, expectedDeletes: []string{}}, "add cert reencrypt": {cfg: &ServiceAliasConfig{Host: "www.example.com", TLSTermination: routev1.TLSTerminationReencrypt, Certificates: map[string]Certificate{"www.example.com": {ID: "testCert"}, "www.example.com" + caCertPostfix: {ID: "testCert"}, "www.example.com" + destCertPostfix: {ID: "testCert"}}}, expectedAdds: []string{cfg.certDir + "testCert", cfg.caCertDir + "testCert"}, expectedDeletes: []string{cfg.certDir + "testCert", cfg.caCertDir + "testCert"}}, "add cert no certs": {cfg: &ServiceAliasConfig{Host: "www.example.com", TLSTermination: routev1.TLSTerminationEdge, Certificates: map[string]Certificate{}}, expectedAdds: []string{}, expectedDeletes: []string{}}, "add cert no tls termination type": {cfg: &ServiceAliasConfig{Host: "www.example.com", Certificates: map[string]Certificate{"www.example.com": {ID: "testCert"}, "www.example.com" + caCertPostfix: {ID: "testCert"}}}, expectedAdds: []string{}, expectedDeletes: []string{}}, "add cert invalid tls termination type": {cfg: &ServiceAliasConfig{Host: "www.example.com", TLSTermination: "invalid", Certificates: map[string]Certificate{"www.example.com": {ID: "testCert"}, "www.example.com" + caCertPostfix: {ID: "testCert"}}}, expectedAdds: []string{}, expectedDeletes: []string{}}}
...
func TestCertManagerConfig(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		shouldPass	bool
	}{"valid": {shouldPass: true, config: validCfg}, "missing certificateKeyFunc": {shouldPass: false, config: missingCertKeyCfg}, "missing caCertificateKeyFunc": {shouldPass: false, config: missingCACertKeyCfg}, "missing destCertificateKeyFunc": {shouldPass: false, config: missingDestCertKeyCfg}, "missing 	certificateDir": {shouldPass: false, config: missingCertDirCfg}, "missing caCertificateDir": {shouldPass: false, config: missingCACertDirCfg}, "matching certificateDir/caCertificateDir": {shouldPass: false, config: matchingCertDirCfg}}
	fakeCertWriter := &fakeCertWriter{}
	for k, tc := range testCases {
