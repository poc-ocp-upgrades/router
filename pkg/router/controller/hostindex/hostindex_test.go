...
func Test_hostIndex(t *testing.T) {
	...
	}{{name: "add", steps: []step{{route: newRoute("test", "1", 0, 1, routev1.RouteSpec{Host: "test.com"})}}, active: map[string][]string{"test.com": {"000"}}, activates: map[string]struct{}{"000": {}}, newRoute: true}, {name: "add - stable", steps: []step{{route: newRoute("test", "1", 0, 1, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "1", 0, 2, routev1.RouteSpec{Host: "test.com"})}}, active: map[string][]string{"test.com": {"000"}}, activates: map[string]struct{}{"000": {}}}, {name: "add - UID change", steps: []step{{route: newRoute("test", "1", 1, 1, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "1", 2, 2, routev1.RouteSpec{Host: "test.com"})}}, active: map[string][]string{"test.com": {"002"}}, activates: map[string]struct{}{"002": {}}}, {name: "add - UID change in reverse order", steps: []step{{route: newRoute("test", "1", 2, 1, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "1", 1, 2, routev1.RouteSpec{Host: "test.com"})}}, active: map[string][]string{"test.com": {"001"}}, activates: map[string]struct{}{"001": {}}}, {name: "add - skip displacement", steps: []step{{route: newRoute("test", "1", 0, 1, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "2", 1, 2, routev1.RouteSpec{Host: "test.com"})}}, active: map[string][]string{"test.com": {"000"}}, inactive: map[string][]string{"test.com": {"001"}}, displaces: map[string]struct{}{"001": {}}, newRoute: true}, {name: "add - displace", steps: []step{{route: newRoute("test", "2", 1, 1, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "1", 0, 2, routev1.RouteSpec{Host: "test.com"})}}, active: map[string][]string{"test.com": {"000"}}, activates: map[string]struct{}{"000": {}}, inactive: map[string][]string{"test.com": {"001"}}, displaces: map[string]struct{}{"001": {}}, newRoute: true}, {name: "coexist", steps: []step{{route: newRoute("test", "1", 0, 1, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "2", 1, 2, routev1.RouteSpec{Host: "test2.com"})}}, active: map[string][]string{"test.com": {"000"}, "test2.com": {"001"}}, activates: map[string]struct{}{"001": {}}, newRoute: true}, {name: "update - active", steps: []step{{route: newRoute("test", "1", 1, 1, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "1", 1, 2, routev1.RouteSpec{Host: "test.com"})}}, active: map[string][]string{"test.com": {"001"}}, activates: map[string]struct{}{"001": {}}}, {name: "update - no change", steps: []step{{route: newRoute("test", "1", 1, 1, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "1", 1, 1, routev1.RouteSpec{Host: "test.com"})}}, active: map[string][]string{"test.com": {"001"}}}, {name: "update - inactive", steps: []step{{route: newRoute("test", "2", 11, 1, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "1", 1, 2, routev1.RouteSpec{Host: "test.com"})}, {remove: true, route: newRoute("test", "2", 11, 3, routev1.RouteSpec{Host: "test.com"})}}, active: map[string][]string{"test.com": {"001"}}}, {name: "update - displace when hostname changes", steps: []step{{route: newRoute("test", "1", 11, 1, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "2", 1, 2, routev1.RouteSpec{Host: "test2.com"})}, {route: newRoute("test", "2", 1, 3, routev1.RouteSpec{Host: "test.com"})}}, active: map[string][]string{"test.com": {"001"}}, activates: map[string]struct{}{"001": {}}, inactive: map[string][]string{"test.com": {"011"}}, displaces: map[string]struct{}{"011": {}}}, {name: "remove - does not exist", steps: []step{{remove: true, route: newRoute("test", "1", 1, 1, routev1.RouteSpec{Host: "test.com"})}}}, {name: "remove - become active", steps: []step{{route: newRoute("test", "1", 1, 1, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "2", 11, 2, routev1.RouteSpec{Host: "test.com"})}, {remove: true, route: newRoute("test", "1", 1, 3, routev1.RouteSpec{Host: "test.com"})}}, active: map[string][]string{"test.com": {"011"}}, activates: map[string]struct{}{"011": {}}}, {name: "remove - multiple inactive", steps: []step{{route: newRoute("test", "3", 111, 1, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "2", 11, 2, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "1", 1, 3, routev1.RouteSpec{Host: "test.com"})}, {remove: true, route: newRoute("test", "1", 1, 4, routev1.RouteSpec{Host: "test.com"})}}, active: map[string][]string{"test.com": {"011"}}, activates: map[string]struct{}{"011": {}}, inactive: map[string][]string{"test.com": {"111"}}}, {name: "remove - multiple inactive - all", steps: []step{{route: newRoute("test", "3", 111, 1, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "2", 11, 2, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "1", 1, 3, routev1.RouteSpec{Host: "test.com"})}, {remove: true, route: newRoute("test", "1", 1, 4, routev1.RouteSpec{Host: "test.com"})}, {remove: true, route: newRoute("test", "2", 11, 5, routev1.RouteSpec{Host: "test.com"})}}, active: map[string][]string{"test.com": {"111"}}, activates: map[string]struct{}{"111": {}}}, {name: "remove - inactive", steps: []step{{route: newRoute("test", "2", 11, 1, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "1", 1, 2, routev1.RouteSpec{Host: "test.com"})}, {remove: true, route: newRoute("test", "2", 11, 3, routev1.RouteSpec{Host: "test.com"})}}, active: map[string][]string{"test.com": {"001"}}}, {name: "remove - does not become active", steps: []step{{route: newRoute("test", "1", 1, 1, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "2", 11, 2, routev1.RouteSpec{Host: "test.com"})}, {remove: true, route: newRoute("test", "2", 11, 3, routev1.RouteSpec{Host: "test.com"})}}, active: map[string][]string{"test.com": {"001"}}}, {name: "multiple changes to same path-based route", activateFn: SameNamespace, steps: []step{{route: newRoute("test", "1", 1, 1, routev1.RouteSpec{Host: "test.com", Path: "/foo"})}, {route: newRoute("test", "1", 1, 2, routev1.RouteSpec{Host: "test.com", Path: "/bar"})}, {route: newRoute("test", "1", 1, 3, routev1.RouteSpec{Host: "test.com", Path: "/foo"})}, {route: newRoute("test", "1", 1, 4, routev1.RouteSpec{Host: "test.com", Path: "/bar"})}, {route: newRoute("test", "1", 1, 5, routev1.RouteSpec{Host: "test.com", Path: "/foo"})}}, active: map[string][]string{"test.com": {"001"}}, activates: map[string]struct{}{"001": {}}}, {name: "remove unchanged path-based route", activateFn: SameNamespace, steps: []step{{route: newRoute("test", "1", 1, 1, routev1.RouteSpec{Host: "test.com", Path: "/foo"})}, {remove: true, route: newRoute("test", "1", 0, 1, routev1.RouteSpec{Host: "test.com", Path: "/foo"})}}}, {name: "remove updated path-based route", activateFn: SameNamespace, steps: []step{{route: newRoute("test", "1", 1, 1, routev1.RouteSpec{Host: "test.com", Path: "/foo"})}, {route: newRoute("test", "1", 1, 2, routev1.RouteSpec{Host: "test.com", Path: "/bar"})}, {route: newRoute("test", "1", 1, 3, routev1.RouteSpec{Host: "test.com", Path: "/foo"})}, {route: newRoute("test", "1", 1, 4, routev1.RouteSpec{Host: "test.com", Path: "/bar"})}, {remove: true, route: newRoute("test", "1", 1, 4, routev1.RouteSpec{Host: "test.com", Path: "/bar"})}}}, {name: "missed delete of path-based route", activateFn: SameNamespace, steps: []step{{route: newRoute("test", "1", 2, 1, routev1.RouteSpec{Host: "test.com", Path: "/foo"})}, {route: newRoute("test", "2", 1, 1, routev1.RouteSpec{Host: "test.com", Path: "/foo"})}}, newRoute: true, active: map[string][]string{"test.com": {"001"}}, activates: map[string]struct{}{"001": {}}, displaces: map[string]struct{}{"002": {}}, inactive: map[string][]string{"test.com": {"002"}}}, {name: "path-based route rejection", activateFn: SameNamespace, steps: []step{{route: newRoute("test", "1", 1, 1, routev1.RouteSpec{Host: "test.com", Path: "/x/y/z"})}, {route: newRoute("test", "2", 2, 1, routev1.RouteSpec{Host: "test.com", Path: "/foo"})}, {route: newRoute("test", "2", 2, 2, routev1.RouteSpec{Host: "test.com", Path: "/bar"})}, {route: newRoute("test", "2", 2, 3, routev1.RouteSpec{Host: "test.com", Path: "/x/y/z"})}}, active: map[string][]string{"test.com": {"001"}}, displaces: map[string]struct{}{"002": {}}, inactive: map[string][]string{"test.com": {"002"}}}}
...
func Test_Filter(t *testing.T) {
	...
	tests := []struct {
		...
		activates	map[string]struct{}
		displaces	map[string]struct{}
	}{{name: "multiple active and inactive routes", steps: []step{{route: newRoute("test", "3", 111, 1, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "2", 11, 2, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "1", 1, 3, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "4", 12, 4, routev1.RouteSpec{Host: "test4.com"})}, {route: newRoute("test", "5", 13, 5, routev1.RouteSpec{Host: "test5.com"})}}, filter: func(route *routev1.Route) bool {
		return route.Name == "5" || route.Name == "2"
	}, active: map[string][]string{"test.com": {"011"}, "test5.com": {"013"}}, activates: map[string]struct{}{"011": {}}}, {name: "remove all inactive", steps: []step{{route: newRoute("test", "3", 111, 1, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "2", 11, 2, routev1.RouteSpec{Host: "test.com"})}, {route: newRoute("test", "1", 1, 3, routev1.RouteSpec{Host: "test.com"})}}, filter: func(route *routev1.Route) bool {
		return route.Name == "1"
