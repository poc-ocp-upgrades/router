...
func (t *fakeTracker) IsChangeContended(id string, now time.Time, ingress *routev1.RouteIngress) bool {
	...
	t.contended[id] = recorded{at: now, ingress: ingress}
	return t.results[id]
}
...
func TestStatusNoOp(t *testing.T) {
	...
	tracker := &fakeTracker{}
	route := &routev1.Route{ObjectMeta: metav1.ObjectMeta{Name: "route1", Namespace: "default", UID: types.UID("uid1")}, Spec: routev1.RouteSpec{Host: "route1.test.local"}, Status: routev1.RouteStatus{Ingress: []routev1.RouteIngress{{Host: "route1.test.local", RouterName: "test", RouterCanonicalHostname: "a.b.c.d", Conditions: []routev1.RouteIngressCondition{{Type: routev1.RouteAdmitted, Status: corev1.ConditionTrue, LastTransitionTime: &touched}}}}}}
...
func TestStatusResetsHost(t *testing.T) {
	...
	tracker := &fakeTracker{}
	route := &routev1.Route{ObjectMeta: metav1.ObjectMeta{Name: "route1", Namespace: "default", UID: types.UID("uid1")}, Spec: routev1.RouteSpec{Host: "route1.test.local"}, Status: routev1.RouteStatus{Ingress: []routev1.RouteIngress{{Host: "route2.test.local", RouterName: "test", Conditions: []routev1.RouteIngressCondition{{Type: routev1.RouteAdmitted, Status: corev1.ConditionTrue, LastTransitionTime: &touched}}}}}}
	lister := &routeLister{items: []*routev1.Route{route}}
...
func TestStatusBackoffOnConflict(t *testing.T) {
	...
	tracker := &fakeTracker{}
	route := &routev1.Route{ObjectMeta: metav1.ObjectMeta{Name: "route1", Namespace: "default", UID: types.UID("uid1")}, Spec: routev1.RouteSpec{Host: "route1.test.local"}, Status: routev1.RouteStatus{Ingress: []routev1.RouteIngress{{Host: "route2.test.local", RouterName: "test", Conditions: []routev1.RouteIngressCondition{{Type: routev1.RouteAdmitted, Status: corev1.ConditionFalse, LastTransitionTime: &touched}}}}}}
	lister := &routeLister{items: []*routev1.Route{route}}
	admitter := NewStatusAdmitter(p, c.Route(), lister, "test", "", noopLease{}, tracker)
	err := admitter.HandleRoute(watch.Added, route)
...
func TestStatusRecordRejection(t *testing.T) {
	...
	c := fake.NewSimpleClientset(&routev1.Route{ObjectMeta: metav1.ObjectMeta{Name: "route1", Namespace: "default", UID: types.UID("uid1")}})
	tracker := &fakeTracker{}
	route := &routev1.Route{ObjectMeta: metav1.ObjectMeta{Name: "route1", Namespace: "default", UID: types.UID("uid1")}, Spec: routev1.RouteSpec{Host: "route1.test.local"}}
	lister := &routeLister{items: []*routev1.Route{route}}
	admitter := NewStatusAdmitter(p, c.Route(), lister, "test", "", noopLease{}, tracker)
...
func TestStatusRecordRejectionNoChange(t *testing.T) {
	...
	c := fake.NewSimpleClientset(&routev1.Route{ObjectMeta: metav1.ObjectMeta{Name: "route1", Namespace: "default", UID: types.UID("uid1")}})
	tracker := &fakeTracker{}
	route := &routev1.Route{ObjectMeta: metav1.ObjectMeta{Name: "route1", Namespace: "default", UID: types.UID("uid1")}, Spec: routev1.RouteSpec{Host: "route1.test.local"}, Status: routev1.RouteStatus{Ingress: []routev1.RouteIngress{{Host: "route1.test.local", RouterName: "test", Conditions: []routev1.RouteIngressCondition{{Type: routev1.RouteAdmitted, Status: corev1.ConditionFalse, Reason: "Failed", Message: "generic error", LastTransitionTime: &touched}}}}}}
	lister := &routeLister{items: []*routev1.Route{route}}
	admitter := NewStatusAdmitter(p, c.Route(), lister, "test", "", noopLease{}, tracker)
	admitter.RecordRouteRejection(route, "Failed", "generic error")
	if len(c.Actions()) != 0 {
...
func TestStatusRecordRejectionOnHostUpdateOnly(t *testing.T) {
	...
	c := fake.NewSimpleClientset(&routev1.Route{ObjectMeta: metav1.ObjectMeta{Name: "route1", Namespace: "default", UID: types.UID("uid1")}})
	tracker := &fakeTracker{}
	route := &routev1.Route{ObjectMeta: metav1.ObjectMeta{Name: "route1", Namespace: "default", UID: types.UID("uid1")}, Spec: routev1.RouteSpec{Host: "route1.test.local"}, Status: routev1.RouteStatus{Ingress: []routev1.RouteIngress{{Host: "route2.test.local", RouterName: "test", Conditions: []routev1.RouteIngressCondition{{Type: routev1.RouteAdmitted, Status: corev1.ConditionFalse, LastTransitionTime: &touched, Reason: "Failed", Message: "generic error"}}}}}}
	lister := &routeLister{items: []*routev1.Route{route}}
	admitter := NewStatusAdmitter(p, c.Route(), lister, "test", "", noopLease{}, tracker)
	admitter.RecordRouteRejection(route, "Failed", "generic error")
	if len(c.Actions()) != 1 {
...
func TestStatusFightBetweenReplicas(t *testing.T) {
	...
	route1 := &routev1.Route{ObjectMeta: metav1.ObjectMeta{Name: "route1", Namespace: "default", UID: types.UID("uid1")}, Spec: routev1.RouteSpec{Host: "route1.test.local"}, Status: routev1.RouteStatus{}}
...
func TestStatusFightBetweenRouters(t *testing.T) {
	...
	tracker := &fakeTracker{}
	route1 := &routev1.Route{ObjectMeta: metav1.ObjectMeta{Name: "route1", Namespace: "default", UID: types.UID("uid1")}, Spec: routev1.RouteSpec{Host: "route2.test-new.local"}, Status: routev1.RouteStatus{Ingress: []routev1.RouteIngress{{Host: "route1.test.local", RouterName: "test1", Conditions: []routev1.RouteIngressCondition{{Type: routev1.RouteAdmitted, Status: corev1.ConditionFalse, LastTransitionTime: &touched1}}}, {Host: "route1.test-new.local", RouterName: "test2", Conditions: []routev1.RouteIngressCondition{{Type: routev1.RouteAdmitted, Status: corev1.ConditionFalse, LastTransitionTime: &touched1}}}}}}
	lister1 := &routeLister{items: []*routev1.Route{route1}}
	...
	route2 := &routev1.Route{ObjectMeta: metav1.ObjectMeta{Name: "route1", Namespace: "default", UID: types.UID("uid1")}, Spec: routev1.RouteSpec{Host: "route2.test-new.local"}, Status: routev1.RouteStatus{Ingress: []routev1.RouteIngress{{Host: "route2.test.local", RouterName: "test1", Conditions: []routev1.RouteIngressCondition{{Type: routev1.RouteAdmitted, Status: corev1.ConditionFalse, LastTransitionTime: &touched1}}}, {Host: "route1.test-new.local", RouterName: "test2", Conditions: []routev1.RouteIngressCondition{{Type: routev1.RouteAdmitted, Status: corev1.ConditionFalse, LastTransitionTime: &touched2}}}}}}
...
func TestRouterContention(t *testing.T) {
	...
	initObj := &routev1.Route{ObjectMeta: metav1.ObjectMeta{Name: "route1", Namespace: "default", UID: types.UID("uid1")}, Spec: routev1.RouteSpec{Host: "route1.new.local"}, Status: routev1.RouteStatus{}}
	i1 := &fakeInformer{}
...
type fakeInformer struct{ handlers []cache.ResourceEventHandler }
